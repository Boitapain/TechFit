<script lang="ts">
    ...
    // Initialize stores after component mounts
    onMount(() => {
        ...
        <div class="navbar-start">
            ...
            <div class="dropdown">
                ...
                >
                    ...
                    <li><a href="/update">{$t("nav.update")}</a></li>
                    <li><a href="/about">{$t("nav.about")}</a></li>
                </ul>
            </div>
            <a href="/" class="btn btn-ghost text-xl">TechFit</a>
        </div>
            ...
            <div class="dropdown dropdown-end">
                ...
                >
                    {#each languages as language}
                        <li>
                            <button onclick={() => changeLang(language.code)}>
                                {language.label}
                            </button>
                        </li>
                    {/each}
